...
final class Admin {
    ...
    void addNewCustomer() throws IOException {
        ...
        do {
            custName = new Scanner(System.in).next();
          //validation for customer name 
            if (custName.matches("[a-zA-Z_]+")) {
                break;
            } else {
                
                System.out.println("ENTER A VALID NAME USING ALBHABETS");
            }
        } while (true);
            ...
            switch (userInput) {
                case 1:
                    ...
                    do {
                        ...
                        while (true) {
                            addCustFlag = new Scanner(System.in).next().toLowerCase();
                            if (addCustFlag.equals("y")) {
                                break;
                            } else if (addCustFlag.equals("n")) {
                                break outer;
                            } else {
